/* 动态改变element-plus主题色 */
import epCss from '/@/style/element/element.scss';
...
export const createColors = (primary: string): any => {
  if (!primary) {
    return {};
  }
  const colors = {
...
// 自动计算hover和active颜色
// https://element-plus.gitee.io/zh-CN/component/button.html#%E8%87%AA%E5%AE%9A%E4%B9%89%E9%A2%9C%E8%89%B2-%E6%B5%8B%E8%AF%95%E7%89%88
